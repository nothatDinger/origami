...
ORIGAMI_QAT_CODEC_PATH="${ORIGAMI_QAT_CODEC_PATH:-dpucomp_dp}" \
...
echo
echo "== Origami connector unit tests =="
cd "${ROOT_DIR}/vllm-0.18.0"
ORIGAMI_LIGHT_IMPORT=1 "${PYTHON_BIN}" -m pytest \
  tests/v1/kv_connector/unit/test_origami_connector.py -q
